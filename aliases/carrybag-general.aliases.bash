...
alias bootstrap='_PWD=$PWD; cd $CB_BASE; cb_bootstrap 2>&1 | tee bootstrap.log; cd $_PWD'
alias housekeeping='_PWD=$PWD; cd $CB_BASE; cb_housekeeping 2>&1 | tee housekeeping.log; cd $_PWD'
